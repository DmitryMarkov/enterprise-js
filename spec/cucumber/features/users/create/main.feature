Feature: Create User
   ...
   Scenario Outline: Invalid profile
      ...
      Examples:
         ...
         | payload                                                                                                                                 | message                                                    |
         | {"email":"e@ma.il","digest":"$2y$10$CaHxr1YxVTQeOedwHeuZT.sJHX8X3pG1wJL7HKjMCfZB/oVjnqpk2","profile":{"foo":"bar"}}                     | The '.profile' object does not support the field 'foo'.    |
         | {"email":"e@ma.il","digest":"$2y$10$CaHxr1YxVTQeOedwHeuZT.sJHX8X3pG1wJL7HKjMCfZB/oVjnqpk2","profile":{"name":{"first":"Jane","a":"b"}}} | The '.profile.name' object does not support the field 'a'. |
         | {"email":"e@ma.il","digest":"$2y$10$CaHxr1YxVTQeOedwHeuZT.sJHX8X3pG1wJL7HKjMCfZB/oVjnqpk2","profile":{"summary":0}}                     | The '.profile.summary' field must be of type string.       |
         | {"email":"e@ma.il","digest":"$2y$10$CaHxr1YxVTQeOedwHeuZT.sJHX8X3pG1wJL7HKjMCfZB/oVjnqpk2","profile":{"bio":0}}                         | The '.profile.bio' field must be of type string.           |
   ...
   Scenario Outline: Valid Profile
      ...
      Examples:
         ...
         | payload                                                                                                                           |
         | {"email":"e@ma.il","digest":"$2y$10$CaHxr1YxVTQeOedwHeuZT.sJHX8X3pG1wJL7HKjMCfZB/oVjnqpk2","profile":{}}                          |
         | {"email":"e@ma.il","digest":"$2y$10$CaHxr1YxVTQeOedwHeuZT.sJHX8X3pG1wJL7HKjMCfZB/oVjnqpk2","profile":{"name":{}}}                 |
         | {"email":"e@ma.il","digest":"$2y$10$CaHxr1YxVTQeOedwHeuZT.sJHX8X3pG1wJL7HKjMCfZB/oVjnqpk2","profile":{"name":{"first":"Daniel"}}} |
         | {"email":"e@ma.il","digest":"$2y$10$CaHxr1YxVTQeOedwHeuZT.sJHX8X3pG1wJL7HKjMCfZB/oVjnqpk2","profile":{"bio":"bio"}}               |
         | {"email":"e@ma.il","digest":"$2y$10$CaHxr1YxVTQeOedwHeuZT.sJHX8X3pG1wJL7HKjMCfZB/oVjnqpk2","profile":{"summary":"summary"}}       |
